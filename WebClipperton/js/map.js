...
function createImageMarker(coords, imageName) {
    ...
    el.className = 'marker';
    el.style.backgroundImage = `url('https://github.com/FDK31/CLIPPERTON/tree/main/WebClipperton/js/img/${imageName}')`;
    el.style.width = '50px';
...
function openImageModal(imageName) {
    ...
    img.src = `https://github.com/FDK31/CLIPPERTON/tree/main/WebClipperton/js/img/${imageName}`;
